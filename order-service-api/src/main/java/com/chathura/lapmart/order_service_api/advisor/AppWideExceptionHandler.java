package com.chathura.lapmart.order_service_api.advisor;
...
public class AppWideExceptionHandler {
    ...
    public ResponseEntity<StandardResponseDto> handleActionNotAllowedException(ActionNotAllowedException e) {
        return new ResponseEntity<>(
